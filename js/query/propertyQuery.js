...
$(function() {
    ...
    function initCustomValue(type, record, tab) {
        ...
        if (type == "line") {
            lineFieldMap = top.fieldMapObj.lineFieldInfo;//jsonData.LineFieldInfo;
        } else {
            lineFieldMap = top.fieldMapObj.pointFieldInfo;//jsonData.PointFieldInfo;
        }
        if (!lineFieldMap) {
            return;
        }
