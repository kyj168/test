...
$(function() {
    ...
    var isTrackControl = false;
    $("#trackDiv").mCustomScrollbar();
    ...
    $("#SaveVisaset").click(function(){//保存街景配置文件 导出\root\userdata\StreetView.xml文件
        ...
        visasetXml+="<floorheight name='"+floorheight.toFixed(2)+"'/>";
        ...
        if(url==""){
    	    ...
    	    var xmlDoc=parent.loadXMLStr(visasetXml);
            //保存文件到userdata目录
    ...
    $("#vistaBrowse").click(function(){
        if(isEnterVista){
            ...
            EnterStreetView(isTrackControl);
        }
    });
