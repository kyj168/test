    ...
    function initObjValue(key, layer,pObj) {
        ...
        if (pObj != null) {
            ...
            if(top.SYSTEMPARAMS.balloonAlpha>0){
                ...
                var htmlStr = '<div style="word-break:keep-all;font-family:Microsoft Yahei;border:1px solid #ccc;white-space:nowrap;overflow:auto;width:255px;height:275px;margin-top:15px;margin-bottom:15px">' + '<table style="font-size:16px;background-color: #ffffff; color: black">';
            ...
            if(top.SYSTEMPARAMS.balloonAlpha>0){
                queryHtmlBalloon.SetRectSize(300, 340);
            }else{
                queryHtmlBalloon.SetRectSize(340, 380);  
            }   
