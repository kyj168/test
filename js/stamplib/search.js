...
var layerGuid = "";
var myicon = null;
var htmlBalloonXYHidden = true;
var htmlBalloonXY = null;
...
STAMP.Search = function(earth) {
    ...
    var keyWordSearch = function(layerId) {
        ...
        var layerText =  $('#layerSelect option:selected').html();
        if(layerText == '当前工程无兴趣点'){
            alert("当前工程无兴趣点");
            emptyResultHtml();
            return;
        }
    ...
    var caculateHeight = function() {
        ...
        pageRecordCount = parseInt((dlgHeight - 240) /27);
        ...
        earth.Event.OnCreateGeometry = function(pval) {
            if (pval) {
                ...
                if(top.SYSTEMPARAMS.balloonAlpha == 0){
                    ...
                    htmlBalloonXY.SetBackgroundAlpha(ba);
                }
                ...
                earth.Event.OnHtmlBalloonFinished = function() {
                    if (htmlBalloonXYHidden == false && htmlBalloonXY != null) {
    ...
    var onSearchCallback = function(keyword, spatialObj, layerId, titleId) {
        ...
        //     showDialog('html/search/searchResult.html', titleId);
        // } else { //先弹出结果页面再搜索
...
*/
    var localSearch = function(guid, keyword, spatialObj) {
        ...
        searchParam.PageRecordCount = parent.pageRecordCount;
    ...
    var showResult = function(searchCurrpage) {
        ...
        for (var i = 0; i < dataRoot.childNodes.length; i++) {
            ...
            htmlStr = htmlStr + '<td width=\"30\" height=\"25\" class=\"\" nowrap><font color="#2A80C9">' + no + '</font></td>';
    ...
    var showVectorMsg = function(record, location) {
        if (record != null) {
            ...
            if(top.SYSTEMPARAMS.balloonAlpha > 0){
                ...
                vectorBallon.SetRectSize(300, 340);
    ...
    var showpoiMsg = function(obj, name) {
        if (obj != null) {
            ...
            if(top.SYSTEMPARAMS.balloonAlpha > 0){//气泡透明
                htmlStr = '<div style="word-break:keep-all;white-space:nowrap;overflow:auto;width:265px;height:310px;margin-top:25px;margin-bottom:25px"><table style="font-size:16px;background-color: #ffffff; color: #fffffe">';
                poihtmlBallon.SetRectSize(300, 340);
    ...
    var showModelDetailMsg = function(obj, key) {
        if (obj != null) {
            ...
            if(top.SYSTEMPARAMS.balloonAlpha>0){
                ...
                htmlBalloons.SetRectSize(300, 340);
            }else{
                htmlStr = '<div style="word-break:keep-all;font-family:Microsoft Yahei;border:1px solid #ccc;white-space:nowrap;overflow:auto;width:255px;height:275px;margin-top:15px;margin-bottom:15px"><table style="font-size:16px;background-color: #fff; color: black">';
