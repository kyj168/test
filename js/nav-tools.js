...
/*-------------------------------------场景START-------------------------------------------------*/
//视点
function ViewPointManagementClicked(){ //视点管理
...
function systemSettingNowClicked(id){
    ...
    //var value = showModalDialog("html/view/systemSettingNow.html", params, "dialogWidth=280px;dialogHeight=600px;dialogLeft:650px;dialogTop:200px;status=no");
}
...
function exportUSXClicked(id){  //导出usx
    analysis.showMoveHtml(id);
}
