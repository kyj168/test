        ...
        function returnValue(){
            ...
            if(userdataObj != null) {
                ...
                //var color = userdataObj.node.getElementsByTagName("FillColor")[0];
                userdataObj.fillcolor = "#" + transparency + fillColor;

                //线透明度
                var lineTransparency = document.getElementById("lineTransparency").value;
                lineTransparency = parseInt(lineTransparency).toString(16);//parseInt(x,16);
                ...
                var drawOrder = document.getElementById("drawOrder").value;
                userdataObj.drawOrder = drawOrder;
                //alert(drawOrder + " " + selectable + " " + editable);
            }
            return userdataObj;
        }
        function check() {
