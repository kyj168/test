...
function returnValue() {
    ...
    if (userdataObj != null) {
        ...
        var frameTransparency = document.getElementById("frameTransparency").value;
        frameTransparency = parseInt(frameTransparency).toString(16); //parseInt(x,16);
        if (frameTransparency.length == 1) {
            frameTransparency = "0" + frameTransparency;
        }
        var lineColor = document.getElementById("lineColor").value;
        lineColor = lineColor.substring(1);
        userdataObj.linecolor = "#" + frameTransparency + lineColor;
        userdataObj.drawFrameEnable = document.getElementById("drawFrameEnable").value;
...
function attributeUserdata() {
    ...
    if (userdataObj.drawFrameEnable != undefined) {
        document.getElementById("drawFrameEnable").value = userdataObj.drawFrameEnable.toString();
        if (userdataObj.drawFrameEnable.toString() == 'true') {
            document.getElementById("drawFrameEnable").selectedIndex = 1;
            document.getElementById("frameTransparency").disabled = false;
            document.getElementById("lineColorSel").disabled = false;
            document.getElementById("lineColor").disabled = false;
        } else {
            document.getElementById("drawFrameEnable").selectedIndex = 0;
            document.getElementById("frameTransparency").disabled = true;
            document.getElementById("lineColorSel").disabled = true;
    ...
    if (userdataObj.linecolor != undefined) {
        var lineColor;
        var frameTransparency;
        lineColor = userdataObj.linecolor;
        var lineColorLen = lineColor.toString().length;
        if (lineColorLen === 3) {
            var colorStr = lineColor.substring(1);
            document.getElementById("lineColor").value = "#" + "0000" + colorStr;
            document.getElementById("frameTransparency").value = 0;
            ...
            document.getElementById("frameTransparency").value = parseInt("0x" + HEX);
...
function drawsel() {
    if (document.getElementById("drawFrameEnable").value == "false") {
        document.getElementById("drawFrameEnable").selectedIndex = 0;
        document.getElementById("frameTransparency").disabled = true;
        document.getElementById("lineColorSel").disabled = true;
        document.getElementById("lineColor").disabled = true;
