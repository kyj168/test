...
function building_submit() {
    ...
    if(check()) {
        if(userdataObj != null) {
            ...
            /* userdataObj.unit = document.getElementById("unit").value; */
...
function attributeUserdata(){
    if("add" == userdataObj.action){
        //document.getElementById("floorTexture").value =earth.Environment.Rootpath + "img\\building_texture.jpg";
