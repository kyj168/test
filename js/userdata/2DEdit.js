...
function attributeUserdata() {
    ...
    if (userdataObj.type === 211) {
        document.getElementById("areaValue").value = userdataObj.area.toFixed(2);
        document.getElementById("perimeterValue").value = userdataObj.perimeter.toFixed(2);
        document.getElementById("areaValue1").value = userdataObj.area.toFixed(2);
    }
    if (userdataObj.type === 228) {
...
function lineColorDlg() {
    var sColor = null;
    sInitColor = document.getElementById("lineColorInput").value;
    if (sInitColor == null) {
    ...
    sColor = "#" + sColor;
    document.getElementById("lineColorInput").value = sColor;
